...
const acumController = require('../controllers/acumController');
...
router.post('/', authMiddleWare.authenticate, async (req, res) => {
    ...
    try {
        ...
        await acumController.calcularProbabilidadAcumulada(
            req,
            res,
            req.user.id,
            tipocalculo,
        ...
        console.error('Error en el cálculo de dsitribución continua:', error);
